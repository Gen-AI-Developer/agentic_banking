...
def get_dynamic_instruction(context: RunContextWrapper[UserInfo], agent: Agent[UserInfo]) -> str:
    return f"Welcome {context.context.userName}, Customer / User account No. {context.context.userAccountNo}, Customer / User account type is {context.context.userAccountType}, Customer / User Account balance is {context.context.userAccountBalance}, and Customer / User account currency is {context.context.userAccountCurrency}. You can ask me about your account details or any banking related queries."
